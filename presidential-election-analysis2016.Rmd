...
election.raw = read.csv("election/election.csv") %>% as.tbl
census_meta = read.csv("census/metadata.csv", sep = ";") %>% as.tbl
census = read.csv("census/census.csv") %>% as.tbl
...
```{r Question 16, echo=FALSE, message=FALSE, cache=TRUE}
